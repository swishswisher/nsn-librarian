      ...
      <section className="min-w-0">
        <div className="border-b border-[var(--nsn-border)] bg-[var(--nsn-card)] px-4 py-4 sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
            ...
            <div
              aria-hidden="true"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-[var(--nsn-border)] bg-[var(--nsn-soft-aqua)] text-xs font-semibold text-[var(--nsn-teal-dark)]"
            >
              N
            </div>
          </div>
