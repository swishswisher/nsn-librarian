...
export function pairingSecretPath() {
  return path.join(bridgeDataDir(), "pairing-secret.json");
}
...
export async function getOrCreatePairingSecret() {
  const filePath = pairingSecretPath();
